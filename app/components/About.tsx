    ...
    <section id="about" aria-labelledby="about-heading" className="py-12 md:py-16 px-4 sm:px-8 md:px-16 lg:px-20 xl:px-44 bg-linear-to-b from-gray-50 to-white scroll-mt-16">
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white rounded-xl flex items-center p-3 sm:p-5 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 border-l-4 border-r-4 border-l-[#084B73] border-r-[#084B73] border border-gray-100"
                  variants={fadeInLeft}
          ...
          <motion.div
            className="lg:col-span-2 bg-white rounded-2xl md:rounded-3xl p-5 sm:p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border-l-4 border-r-4 border-l-[#084B73] border-r-[#084B73] border border-gray-100"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
